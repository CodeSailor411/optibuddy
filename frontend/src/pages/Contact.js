...
const Contact = () => {
    useDocTitle('OptiBuddy | Get in Touch');
                        ...
                        <div className="flex flex-col text-white">
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">MAZER Labs - Ras Tabia, Tunis</p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: +216 99 085 995</p>

                                    <div className="mt-5">
                                        <h2 className="text-2xl">Email Us</h2>
                                        <p className="text-gray-400">support@optibuddy.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
